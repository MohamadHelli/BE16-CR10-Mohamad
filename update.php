...
<html>
    ...
    <body>
        <fieldset>
            <legend class='h2'>Update request <img class='img-thumbnail rounded-circle' src='pic/<?php echo $picture ?>' alt="<?php echo $name ?>"></legend>
            <form action="actions/a_update.php"  method="post" enctype="multipart/form-data">
                <table class="table">
                    ...
                    <tr>
                        <th>ISBN code</th>
                        <td><input class="form-control" type= "number" name="isbncode" step="any"  placeholder="123" value ="<?php echo $isbncode ?>" /></td>
                    </tr>
                    <tr>
                        <th>Description</th>
                        <td><input class="form-control" type="text"  name="dis" placeholder ="Description" value="<?php echo $dis ?>"  /></td>
                    </tr>
                    <tr>
                    <th>Type</th>
                    ...
                    <tr>
                        <th>Publish Date</th>
                        <td><input class="form-control" type="text"  name="publish_date" value="<?php echo $publish_date ?>"  /></td>
                    </tr>
                    <tr>
                    <th>Status</th>
